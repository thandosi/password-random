...
log_btn = Button(root, text="Login", borderwidth="10", bg="Aqua", font=("sanseraf"), command=log)
log_btn.place(x=125, y=100)
clear_btn = Button(root, text="Clear", borderwidth="10", bg="Aqua", font=("sanseraf"), command=clear)
